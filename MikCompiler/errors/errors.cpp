...
void throw_error(int err_code, Lexer state) {
  ...
  case UNTERMINATED_MULTILINE_COMMENT: {
    cout << RED << "\n\r[ERROR " << to_string(UNTERMINATED_MULTILINE_COMMENT)
  ...
  case UNTERMINATED_CHARACTER_LITERAL: {
    cout << RED << "\n\r[ERROR " << to_string(UNTERMINATED_CHARACTER_LITERAL)
  ...
  case CLOSING_PARENTHESIS_EXPECTED_IN_FILE_COMPILER_DIRECTIVE: {
    cout << RED << "\n\r[ERROR "
         << to_string(CLOSING_PARENTHESIS_EXPECTED_IN_FILE_COMPILER_DIRECTIVE)
  ...
  case OPENING_PARENTHESIS_EXPECTED_IN_FILE_COMPILER_DIRECTIVE: {
    cout << RED << "\n\r[ERROR "
         << to_string(OPENING_PARENTHESIS_EXPECTED_IN_FILE_COMPILER_DIRECTIVE)
...
void throw_error(int err_code, Parser state) {
  ...
  case EXPECTED_VARIABLE_NAME_AFTER_TYPE: {
    cout << RED << "\n\r[ERROR " << to_string(EXPECTED_VARIABLE_NAME_AFTER_TYPE)
         << " A name was expected after a type in the definition/declaration "
            "of a variable:\n";
    print_error_location(state);
    cout << GREEN << "\nRead more about this error: "
  ...
  case EXPECTED_BOUND_OR_ARRAY_DEFINITION_OR_ASSIGNMENT_AFTER_VARIABLE_NAME: {
    cout
        ...
        << "A boundary ({}), array ([]), or assignment (=) was expected after "
